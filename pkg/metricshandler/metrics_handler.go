...
func (m *MetricsHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// We do not support protobuf at the moment. Fall back to FmtText if the negotiated exposition format is not FmtOpenMetrics See: https://github.com/nholuongut/kube-state-metrics/issues/2022.
