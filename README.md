...
At most, 5 kube-state-metrics and 5 [kubernetes releases](https://github.com/nholuongut/kubernetes/releases) will be recorded below.
...
The [metrics-server](https://github.com/nholuongut/metrics-server)
...
#### For users of nholuongut/kube-prometheus stack

The ([`kube-prometheus`](https://github.com/nholuongut/kube-prometheus/)) stack installs kube-state-metrics as one of its [components](https://github.com/nholuongut/kube-prometheus#kube-prometheus); you do not need to install kube-state-metrics if you're using the kube-prometheus stack.

If you want to revise the default configuration for kube-prometheus, for example to enable non-default metrics, have a look at [Customizing Kube-Prometheus](https://github.com/nholuongut/kube-prometheus/blob/main/docs/customizing.md).
